...
silent only
cd ~/Projects/grownbyus
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4 grownbyus.coffee
badd +22 server/helpers.coffee
badd +1 server/server.coffee
badd +1 lib/helpers.coffee
badd +1 client/client.coffee
badd +1 grownbyus.html
badd +1 grownbyus.styl
badd +0 client/aux.js
badd +14 x.css
badd +0 x.styl
silent! argdel *
edit server/server.coffee
...
exe 'vert 1resize ' . ((&columns * 131 + 132) / 264)
exe '2resize ' . ((&lines * 18 + 34) / 69)
exe 'vert 2resize ' . ((&columns * 131 + 132) / 264)
exe '3resize ' . ((&lines * 29 + 34) / 69)
exe 'vert 3resize ' . ((&columns * 131 + 132) / 264)
exe '4resize ' . ((&lines * 59 + 34) / 69)
exe 'vert 4resize ' . ((&columns * 132 + 132) / 264)
exe '5resize ' . ((&lines * 7 + 34) / 69)
exe 'vert 5resize ' . ((&columns * 132 + 132) / 264)
argglobal
...
setlocal tabstop=2
setlocal tags=./tags,./TAGS,tags,TAGS,~/Projects/grownbyus/.git/coffee.tags,~/Projects/grownbyus/.git/tags
...
let s:l = 23 - ((15 * winheight(0) + 9) / 18)
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ \ $*\ lib/helpers.coffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
setlocal tabstop=2
setlocal tags=./tags,./TAGS,tags,TAGS,~/Projects/grownbyus/.git/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 88 + 132) / 264)
exe 'vert 2resize ' . ((&columns * 67 + 132) / 264)
exe 'vert 3resize ' . ((&columns * 107 + 132) / 264)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal tabstop=2
setlocal tags=./tags,./TAGS,tags,TAGS,~/Projects/grownbyus/.git/html.tags,~/Projects/grownbyus/.git/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal tabstop=2
setlocal tags=./tags,./TAGS,tags,TAGS,~/Projects/grownbyus/.git/stylus.tags,~/Projects/grownbyus/.git/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 65 - ((49 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 271 - ((138 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
271
